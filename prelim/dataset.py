...
def get_dataset(dataname, top_k):
    ...
    edge_index, features, labels, train_mask, val_mask, test_mask, sens, header = load(
    ...
    return Data(x=features, edge_index=edge_index, y=labels.float(), train_mask=train_mask, val_mask=val_mask, test_mask=test_mask, sens=sens), sens_idx, header
